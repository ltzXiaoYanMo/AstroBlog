...
image: ./assets/images/firefly1.avif
...
[grid]
![左侧边栏+列表布局](./assets/images/left-list.avif)
![右侧边栏+网格布局](./assets/images/right-grid2.avif)
![左侧边栏+三列网格布局](./assets/images/left-grid3.avif)
[/grid]

[grid]
![双侧边栏+列表布局](./assets/images/both-list.avif)
![双侧边栏+网格布局](./assets/images/both-grid.avif)
![双侧边栏+网格瀑布流布局](./assets/images/masonry.avif)
[/grid]
...
![左侧边栏布局](./assets/images/left-list.avif)

#### 右侧边栏 (position: "right")

![右侧边栏布局](./assets/images/right-grid2.avif)
...
![列表模式布局](./assets/images/left-list.avif)
...
![网格布局](./assets/images/left-grid3.avif)
...
![瀑布流布局](./assets/images/masonry.avif)
